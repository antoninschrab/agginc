"""
This file contains functions to sample from perturbed uniform distributions.
It is taken from the implementation:
https://github.com/antoninschrab/mmdagg-paper/blob/master/sampling.py
MMD Aggregated Two-Sample Test
Antonin Schrab, Ilmun Kim, Mélisande Albert,
Béatrice Laurent, Benjamin Guedj, Arthur Gretton
